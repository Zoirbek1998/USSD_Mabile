                        ...
                        CATEGORY_INTERNET -> {
                            return listOf(
                                CategoryModel("KUN", listOf(
                                    InternetModel("Kun 30", "1 900 so'm", "30+30 MB", "100% bonus ijtimoiy tarmoqlar va messenjerlarga(30 MB)", "*110*0*16#"),
                                    InternetModel("Kun 150", "4 900 so'm", "150+150 MB", "100% bonus ijtimoiy tarmoqlar va messenjerlarga(150 MB)", "*110*0*17#")
                                )),
                                ...
                                CategoryModel("OY", listOf(
                                    InternetModel("260", "13 472 so'm", "338 MB", "30% bonus ijtimoiy tarmoqlar va messenjerlarga(78 MB)", "*110*0*03#"),
                                    InternetModel("800", "23 155 so'm", "1040 MB", "30% bonus ijtimoiy tarmoqlar va messenjerlarga(240 MB)", "*110*0*04#"),
                                    InternetModel("1 500", "31 575 so'm", "1950 MB", "30% bonus ijtimoiy tarmoqlar va messenjerlarga(450 MB)", "*110*0*05#"),
                                    InternetModel("2 100", "42 100 so'm", "2730 MB", "30% bonus ijtimoiy tarmoqlar va messenjerlarga(630 MB)", "*110*0*06#"),
                                    InternetModel("4 000", "54 730 so'm", "5200 MB", "30% bonus ijtimoiy tarmoqlar va messenjerlarga(1200 MB)", "*110*0*07#"),
                                    InternetModel("6 000", "84 200 so'm", "7800 MB", "30% bonus ijtimoiy tarmoqlar va messenjerlarga(1800 MB)", "*110*0*08#"),
                                    InternetModel("8 500", "113 670 so'm", "11050 MB", "30% bonus ijtimoiy tarmoqlar va messenjerlarga(2550 MB)", "*110*0*09#"),
                                    InternetModel("13 000", "138 930 so'm", "16900 MB", "30% bonus ijtimoiy tarmoqlar va messenjerlarga(3900 MB)", "*110*0*15#"),
                                    InternetModel("20 000", "168 400 so'm", "26000 MB", "30% bonus ijtimoiy tarmoqlar va messenjerlarga(6000 MB)", "*110*0*27#"),
                                    InternetModel("35 000", "210 500 so'm", "45500 MB", "30% bonus ijtimoiy tarmoqlar va messenjerlarga(10500 MB)", "*110*0*28#"),
                                    InternetModel("70 000", "252 600 so'm", "91000 MB", "30% bonus ijtimoiy tarmoqlar va messenjerlarga(21000 MB)", "*110*0*29#")
                        ...
                        CATEGORY_TARIF -> {
                            return listOf(
                                CategoryModel("", listOf(
                                    ...
                                    TarifModel("Yangi Super XIT",  "30 333 so'm",  "30 kun",  "Ulaning! Muloqotni boshlang, zavq oling!\n" +
                                            "\n" +
                                            "\n" +
                                            "● 30 000 so'm Oylik abonent to’lovi chegirma bilan*\n" +
                                            "BEPUL PAKETLAR\n" +
                                            "● 1,000 O‘zbekiston bo‘yicha mobil operatorlariga\n" +
                                            "● 4,000 MB mobil internet\n" +
                                            "● 400 SMS O'zbekiston bo'yicha barcha yo'nalishlar uchun kiritilgan SMS paketi\n" +
                                            "BEPUL PAKETLAR LIMITIDAN OSHGANDA\n" +
                                            "● 100 so‘m tarmoq ichida qo‘ng‘iroqlar\n" +
                                            "● 125 so‘m O‘zbekistonning boshqa mobil operatorlari, shaxar telefon raqamlariga\n" +
                                            "● 120 so‘m chiquvchi maxalliy SMS-xabarlar barcha mobil operatorlarga\n" +
                                            "● 630 so‘m 1 MB Internet-trafik uchun\n" +
                                            "SHARTLAR\n" +
                                            "●  «Bir Oy», «Yangi MEGA XIT», «Yangi TOP XIT» tariflari, «Status» va «Status+» turkumidagi tarif rejalardan o‘tish narxi - 2,000 so‘m\n" +
                                            "●  Boshqa tariflardan o‘tish narxi - 0 so‘m\n" +
                                            "●  Beeline TV va Beeline Music uchun 30 kunlik promo-muddat tarifga kiritilgan\n" +
                                            "●  «Perezagruzka» xizmatini ulab daqiqa va MB paketlarning yangidan taqdim etish imkoniyatingiz mavjud",  "*110*37#"),
                                    ...
                                    TarifModel("Status Silver New", "88 000 so'm",  "30 kun",  "Suhbat erkinligiga intiling! Erkin suhbatdan baxra oling, hissiyotlarni muloqot orqali yetkazing!\n" +
                                            "\n" +
                                            "\n" +
                                            "BEPUL PAKETLAR\n" +
                                            "● 18,000 daqiqa tarmoq ichida va O‘zbekiston bo‘yicha barcha mobil operatorlariga\n" +
                                            "● 8,000 SMS xabarlar barcha yo‘nalishlar uchun\n" +
                                            "● 18,000 MB mobil internet\n" +
                                            "● 100 MB Roumingda VEON hududida foydalanish uchun kiritilgan MB paketi\n" +
                                            "● 210 500 SO'M Bepul «Oltin» raqam\n" +
                                            "● 88 250 so‘m Tarifga o'tish uchun hisobdagi minimal mablag’ miqdori \n" +
                                    ...
                                    TarifModel("Bravo Online", "550 so'm","1 kun", "Hisobni to‘ldirgandagi bonuslar, daqiqalar va megabaytlar! Biz sizga faqat eng yaxshisini ilinamiz!\n" +
                                            "\n" +
                                            "\n" +
                                            "HISOBNI TO‘LDIRGANDA BONUSLAR\n" +
                                            "●  8,000-12,000 so‘m - Tarmoq ichida 100 daqiqa 7 kun davomida + 100 MB Telegram, WhatsApp va Viber uchun 7 kunga taqdim etiladi\n" +
                                            "●  12,000-16,000 so‘m - Tarmoq ichida 250 daqiqa 7 kun davomida + Tarmoq ichida 250 daqiqa shanba va yakshanba kunlar uchun + 250 MB Telegram, WhatsApp va Viber uchun 7 kunga taqdim etiladi\n" +
                                            "●  16,000 so‘m va undan yuqori - Tarmoq ichida 500 daqiqa 7 kun davomida + 500 MB Facebook, Odnoklassniki, TAS-IX, Telegram, WhatsApp va Viber uchun 7 kunga taqdim etiladi\n" +
                                            "NARXLAR\n" +
                                            "● 95 so‘m tarmoq ichida qo‘ng‘iroqlar\n" +
                                            "● 125 so‘m O‘zbekistonning boshqa mobil operatorlari, shaxar telefon raqamlariga\n" +
                                            "● 85 so‘m chiquvchi maxalliy SMS-xabarlar barcha mobil operatorlarga\n" +
                                            "● 420 so‘m 1 MB Internet-trafik uchun\n" +
                                            "SHARTLAR\n" +
                                            "●  100 MB ijtimoiy tarmoqlar uchun kunlik bepul paket\n" +
                                            "●  «Bravo Ooo!», «Qo‘shnilar +», «Click», «Mi-Fi Click», «Yangi O!», «G‘alaba!» tariflaridan o‘tish - 2,000 so‘m\n" +
                                            "●  Boshqa tariflardan o‘tish - 0 so‘m\n" +
                                            "●  To‘langan mablag‘ni aloqaning barcha xizmatlariga sarflashingiz mumkin",  "*110*570#"),
                                    TarifModel("Click+", "15 000 so'm","30 kun", "Internet uchun yaxshi tarif reja! Oylik bepul internet paketlar hamda 1 MB trafik narxi 85 so‘m. \n" +
                                            ...
                                            "● 1,000 MB internet trafik\n" +
                                            "● 1,000 MB Facebook, Odnoklassniki, Telegram, WhatsApp va Viber uchun\n" +
                                            "● 1,000 MB «TAS-IX» hududiga kiradigan saytlar uchun\n" +
                                            "BEPUL PAKETLAR LIMITIDAN OSHGANDA\n" +
                                    ...
                                    TarifModel("Bolajon", "11 500 so'm","30 kun", "Farzandingiz uchun kerakli Internet! Bolajonlar uchun xavfsiz internet, ular uchun eng yaxshisi!\n" +
                                            ...
                                            "●  \"Bolajon\" tarifini boshqa tarifga o‘zgartirish uchun raqam egasi Kompaniya rasmiy ofislariga pasport bilan murojaat qilib, ariza qoldirishi kerak",  "*110*538#")
                                ))
                            )
                        }
                        CATEGORY_MINUTES -> {
                        ...
                        CATEGORY_ADVEN -> {
                            return listOf(
                                CategoryModel("USSD kodlar", listOf(
                                    ...
                                    AdventageModel("Perezagruzka xizmati", "*5#"),
                                    AdventageModel("Beeline TV", "*6#"),
                                    AdventageModel("Beeline Music", "*9#"),
                        ...
                        CATEGORY_INTERNET -> {
                            return listOf(
                                ...
                                CategoryModel("KUNLIK", listOf(
                                    InternetModel("100MB", "3 000 so'm", "100 MB", "Faollashtirilgandan so’ng 24 soat davomida", "*121*1*3*1#"),
                                    InternetModel("300MB", "6 000 so'm", "300 MB", "Faollashtirilgandan so’ng 24 soat davomida", "*121*1*3*2#"),
                                    InternetModel("600MB", "9 000 so'm", "600 MB", "Faollashtirilgandan so’ng 24 soat davomida", "*121*1*3*3#")
                                )),
                                CategoryModel("OYLIK", listOf(
                                    InternetModel("500 MB", "10 000 so'm", "500 MB", "30 kun", "*147*10072*39464#"),
                                    InternetModel("1 500 MB", "15 000 so'm", "1500 MB", "30 kun", "*147*10073*39464#"),
                                    InternetModel("3 000 MB", "24 000 so'm", "3000 MB", "30 kun", "*147*10074*39464#"),
                                    InternetModel("5 000 MB", "32 000 so'm", "5000 MB", "30 kun", "*147*10075*39464#"),
                                    InternetModel("8 000 MB", "41 000 so'm", "8000 MB", "30 kun", "*147*10076*39464#"),
                                    InternetModel("12 000 MB", "50 000 so'm", "12000 MB", "30 kun", "*147*10074*39464#"),
                                    InternetModel("20 000 MB", "65 000 so'm", "20000 MB", "30 kun", "*147*10078*39464#"),
                                    InternetModel("30 000 MB", "75 000 so'm", "30000 MB", "30 kun", "*147*10079*39464#"),
                                    InternetModel("50 000 MB", "85 000 so'm", "50000 MB", "30 kun", "*147*10080*39464#"),
                                    InternetModel("75 000 MB", "110 000 so'm", "75000 MB", "30 kun", "*147*10150*39464#")
                                )),
                                ...
                                CategoryModel("OYLIK NON-STOP", listOf(
                                    InternetModel("3 000 MB non-stop", "Birinchi oy(24 000 so'm)", "Keyingi oylardan(21 600)", "Har 30 kun", "*147*10055*39464#"),
                                    InternetModel("5 000 MB non-stop", "Birinchi oy(32 000 so'm)", "Keyingi oylardan(28 800)", "Har 30 kun", "*147*10056*39464#"),
                                    InternetModel("8 000 MB non-stop", "Birinchi oy(41 000 so'm)", "Keyingi oylardan(36 900)", "Har 30 kun", "*147*10057*39464#"),
                                    InternetModel("12 000 MB non-stop", "Birinchi oy(50 000 so'm)", "Keyingi oylardan(45 000)", "Har 30 kun", "*147*10151*39464#"),
                                    InternetModel("20 000 MB non-stop", "Birinchi oy(65 000 so'm)", "Keyingi oylardan(58 500)", "Har 30 kun", "*111*1*14*5*1#"),
                                    InternetModel("30 000 MB non-stop", "Birinchi oy(75 000 so'm)", "Keyingi oylardan(67 500)", "Har 30 kun", "*111*1*14*6*1#"),
                                    InternetModel("50 000 MB non-stop", "Birinchi oy(80 000 so'm)", "Keyingi oylardan(76 500)", "Har 30 kun", "*111*1*14*7*1#")
                                ))
                            )
                        }
                        CATEGORY_TARIF -> {
                            return listOf(
                                CategoryModel("UNITS", listOf(
                                    TarifModel("UNITS 7000", "7 000 so'm","7 kun", "700 UNITS\n" +
                                            "\n" +
                                            "\n" +
                                            "TARIF NARXLARI\n" +
                                    ...
                                    TarifModel("UNITS 1500", "15 000 so'm","15 kun", "1500 UNITS\n" +
                                            ...
                                            "● 1 SMS - 1 UNIT\n" +
                                            "● 1 MB - 1 UNIT \n",  "*333*2#"),
                                    TarifModel("UNITS 3500", "20 000 so'm","15 kun", "3500 UNITS\n" +
                                            "\n" +
                                            "\n" +
                                            "TARIF NARXLARI\n" +
                                            ...
                                            "● 1 SMS - 1 UNIT\n" +
                                            "● 1 MB - 1 UNIT \n",  "*333*3#"),
                                    TarifModel("UNITS 7000", "35 000 so'm","30 kun", "7000 UNITS\n" +
                                            "\n" +
                                            "\n" +
                                            "TARIF NARXLARI\n" +
                                            ...
                                            "● 1 SMS - 1 UNIT\n" +
                                            "● 1 MB - 1 UNIT \n",  "*333*4#"),
                                    TarifModel("UNITS 10 000", "45 000 so'm","30 kun", "10 000 UNITS\n" +
                                            "\n" +
                                            "\n" +
                                            "TARIF NARXLARI\n" +
                                            ...
                                            "● 1 SMS - 1 UNIT\n" +
                                            "● 1 MB - 1 UNIT \n",  "*333*5#"),
                                    TarifModel("UNITS 13 000", "55 000 so'm","30 kun", "13 000 UNITS\n" +
                                            "\n" +
                                            "\n" +
                                            "TARIF NARXLARI\n" +
                                            ...
                                            "● 1 SMS - 1 UNIT\n" +
                                            "● 1 MB - 1 UNIT \n",  "*333*6#"),
                                    TarifModel("UNITS 17 000", "65 000 so'm","30 kun", "17 000 UNITS\n" +
                                            "\n" +
                                            "\n" +
                                            "TARIF NARXLARI\n" +
                                            ...
                                            "● 1 SMS - 1 UNIT\n" +
                                            "● 1 MB - 1 UNIT \n",  "*333*7#"),
                                    TarifModel("UNITS 21 000", "75 000 so'm","30 kun", "21 000 UNITS\n" +
                                            "\n" +
                                            "\n" +
                                            "TARIF NARXLARI\n" +
                                ...
                                CategoryModel("Tariflar", listOf(
                                    ...
                                    TarifModel("Komfort", "38 000 so'm","30 kun", "Qulay narxlarda ishonchli tarif, komfort sifati endi telefoningizda!\n" +
                                            "\n" +
                                            "\n" +
                                            "OYLIK BEPUL PAKETLAR\n" +
                                            "● 1,400 daqiqa tarmoq ichida\n" +
                                            "● 700 daqiqa O‘zbekistonning boshqa operatorlariga\n" +
                                            "● 3,000 MB mobil internet\n" +
                                            "● 700 SMS xabarlar\n" +
                                            "BEPUL PAKETLAR LIMITIDAN OSHGANDA\n" +
                                            "● 84 so‘m O‘zbekiston bo‘ylab chiqish qo‘ng‘iroqlari 1 daqiqasi\n" +
                                            "● 63 so‘m tarmoq ichida chiqish qo‘ng‘iroqlari 1 daqiqasi\n" +
                                            "● 63 so‘m 1 ta SMS-xabar narxi\n" +
                                            "● 160 so‘m 1 MB Internet trafigi\n" +
                                            "SHARTLAR\n" +
                                            "●  \"Komfort\" tarif rejasi jismoniy shaxslar uchun taqdim etiladi\n" +
                                            "●  Tarif rejaga kiritilgan daqiqa limiti, SMS va Internet-trafik bir kalendar oyi muddatiga taqdim etiladi\n" +
                                            "●  Foydalanilmagan limit keyingi oyga o‘tkazilmaydi.",  "*111*1*11*9#"),
                ...
                OPERATOR_UCELL -> {
                    when(category){
                        CATEGORY_INTERNET -> {
                            return listOf(
                            CategoryModel("OYLIK", listOf(
                                    InternetModel("To'plam 500", "8 900 so'm", "500 MB", "", "*555*3*1*1*1#"),
                                    InternetModel("To'plam 1 GB", "13 000 so'm", "1024 MB", "", "*555*3*2*1*1#"),
                                    InternetModel("To'plam 2 GB", "15 000 so'm", "1536 MB", "", "*555*3*3*1*1#"),
                                    InternetModel("To'plam 3 GB", "25 000 so'm", "3072 MB", "", "*555*3*4*1*1#"),
                                    InternetModel("To'plam 5 GB", "35 000 so'm", "5120 MB", "", "*555*3*5*1*1#"),
                                    InternetModel("To'plam 10 GB", "55 000 so'm", "10 240 MB", "", "*555*3*6*1*1#"),
                                    InternetModel("To'plam 12 GB", "65 000 so'm", "12 288 MB", "", "*555*3*7*1*1#"),
                                    InternetModel("To'plam 14 GB", "75 000 so'm", "14 336 MB", "", "*555*3*8*1*1#"),
                                    InternetModel("To'plam 16 GB", "85 000 so'm", "16384 MB", "", "*555*3*9*1*1#"),
                                    InternetModel("To'plam 32 GB", "115 000 so'm", "32768 MB", "", "*555*3*11*1*1#"),
                                    InternetModel("To'plam 64 GB", "135 000 so'm", "65536 MB", "", "*555*3*12*1*1#"),
                                    InternetModel("To'plam 128 GB", "188 000 so'm", "131072 MB", "", "*555*3*13*1*1#")
                                )),
                                CategoryModel("AKSIYA", listOf(
                                    InternetModel("1 GB", "8 000 so'm", "1 000 MB", "A’lo kayifyat  va COSMO tariflar tizimi uchun" , "*255#"),
                                    InternetModel("2 GB", "10 000 so'm", "2 000 MB", "Active va Special tariflar tizimi uchun" , "*255#"),
                                    InternetModel("3 GB", "15 000 so'm", "3 000 MB", "Active va Special tariflar tizimi uchun" , "*255#"),
                                    InternetModel("Youtube uchun (30 kun)", "8 000 so'm", "5000 MB", "Aksiya doirasida Youtube uchun megabaytlar sotib oling!\n" +"Yanada qulayroq usulda harid qilish uchun telegram orqali murojat qiling:\n" +"@Nussa0707", "*255#"),
                                    InternetModel("Messenger uchun (30 kun)", "3 000 so'm", "1000 MB", "Aksiya doirasida Messenger uchun megabaytlar sotib oling!\n" +"Yanada qulayroq usulda harid qilish uchun telegram orqali murojat qiling:\n" +"@Nussa0707", "*255#"),
                                    InternetModel("Internet TAS-IX uchun (30 kun)", "10 000 so'm", "5000 MB", "Aksiya doirasida Internet TAS-IX uchun megabaytlar sotib oling! \n" +"Yanada qulayroq usulda harid qilish uchun telegram orqali murojat qiling:\n" +"@Nussa0707", "*255#"),
                                    InternetModel("Internet TAS-IX uchun (30 kun)", "15 000 so'm", "10000 MB", "Aksiya doirasida Internet TAS-IX uchun megabaytlar sotib oling! \n" +"Yanada qulayroq usulda harid qilish uchun telegram orqali murojat qiling:\n" +"@Nussa0707", "*255#"),
                                    InternetModel("Special va Active uchun (30 kun)", "10 000 so'm", "2000 MB", "Aksiya doirasida Special va Active tariflari uchun megabaytlar sotib oling! \n" +"Yanada qulayroq usulda harid qilish uchun telegram orqali murojat qiling:\n" +"@Nussa0707", "*255#"),
                                    InternetModel("Special va Active uchun (30 kun)", "15 000 so'm", "3000 MB", "Aksiya doirasida Special va Active tariflari uchun megabaytlar sotib oling! \n" +"Yanada qulayroq usulda harid qilish uchun telegram orqali murojat qiling:\n" +"@Nussa0707", "*255#")
                                )),
                                ...
                                CategoryModel("KUNLIK", listOf(
                                    InternetModel("To‘plam 4", "336.8 so'm", "4 MB", "", "*555*1*1*1#"),
                                    InternetModel("To‘plam 8", "500 so'm", "8 MB", "", "*555*1*2*1#"),
                                    InternetModel("To‘plam 15", "700 so'm", "15 MB", "", "*555*1*3*1#"),
                                    InternetModel("To‘plam 25", "1 100 so'm", "25 MB", "", "*555*1*4*1#"),
                                    InternetModel("To‘plam 40", "1 700 so'm", "40 MB", "", "*555*1*5*1#"),
                                    InternetModel("To‘plam 60", "2 500 so'm", "60 MB", "", "*555*1*6*1#"),
                                    InternetModel("To‘plam 100", "3 500 so'm", "100 MB", "", "*555*1*7*1#"),
                                    InternetModel("To‘plam 130", "4 000 so'm", "130 MB", "", "*555*1*8*1#"),
                                    InternetModel("To‘plam 150", "4 500 so'm", "150 MB", "", "*555*1*9*1#")
                                )),
                        ...
                        CATEGORY_TARIF -> {
                            return listOf(
                                CategoryModel("OYLIK", listOf(
                                    ...
                                    TarifModel("Student", "8 000 so'm","30 kun", "Biz bilan hatto o‘qish va o‘rganish ham osonlashadi! O‘rgan student!\n" +
                                            "\n" +
                                            "\n" +
                                            "OYLIK BEPUL PAKETLAR\n" +
                                            "● 500 daqiqa tarif ichida chiquvchi qo‘ng‘iroqlarga\n" +
                                            "● 200 daqiqa O‘zbekiston bo‘yicha chiqish qo‘ng‘iroqlariga\n" +
                                            "● 100 MB mobil internet tarfik\n" +
                                            "● 500 MB Facebook, Telegram, WhatsApp uchun\n" +
                                            "● 500 MB tungi vaqt (01:00-09:00) uchun trafik\n" +
                                            "● 200 SMS xabarlar\n" +
                                            "BEPUL PAKETLAR LIMITIDAN OSHGANDA\n" +
                                    ...
                                    TarifModel("Katta Tantana", "20 000 so'm","30 kun", "Katta tantanaga tayyormisiz? Suhbat erkinligini his eting, muloqotni boshlang!\n" +
                                            ...
                                            "\n" +
                                            "BEPUL OYLIK PAKETLAR\n" +
                                            "● 750 daqiqa O‘zbekiston bo‘yicha chiquvchi qo‘ng‘iroqlar\n" +
                                            "● 750 O‘zbekiston bo‘yicha chiquvchi SMSlar\n" +
                                            "BEPUL PAKETLAR LIMITIDAN OSHGANDA\n" +
                                            "● 95 so‘m tarmoq ichida chiquvchi qo‘ng‘iroqlar\n" +
                                            "● 125 so‘m O‘zbekiston bo‘yicha chiquvchi qo‘ng‘iroqlar\n" +
                                            "● 80 so‘m chiquvchi SMS-xabarlar barcha mobil operatorlarga\n" +
                                    ...
                                    TarifModel("Super Tantana", "30 000 so'm","30 kun", "Yaqinlaringizga yanada yaqinroq bo‘ling, super tantana bilan barchasi a’lo!\n" +
                                            ...
                                            "\n" +
                                            "BEPUL OYLIK PAKETLAR\n" +
                                            "● 1,500 daqiqa O‘zbekiston bo‘yicha chiquvchi qo‘ng‘iroqlar\n" +
                                            "● 1,000 O‘zbekiston bo‘yicha chiquvchi SMSlar\n" +
                                            "BEPUL PAKETLAR LIMITIDAN OSHGANDA\n" +
                                            "● 95 so‘m tarmoq ichida chiquvchi qo‘ng‘iroqlar\n" +
                                            "● 125 so‘m O‘zbekiston bo‘yicha chiquvchi qo‘ng‘iroqlar\n" +
                                            "● 80 so‘m chiquvchi SMS-xabarlar barcha mobil operatorlarga\n" +
                                    ...
                                    TarifModel("Cosmo 16",  "16 000 so'm",  "30 kun", "Cosmosdagidek tasurotlarga ega bo'ling\n" +
                                            ...
                                            "\n" +
                                            "BEPUL OYLIK PAKETLAR\n" +
                                            "● 600 daqiqa O‘zbekiston bo‘yicha chiquvchi qo‘ng‘iroqlar\n" +
                                            "● 50 SMS O‘zbekiston bo‘yicha chiquvchi qo‘ng‘iroqlar\n" +
                                            "● 1 000 MB internet trafik\n" +
                                            "● 1 000 MB Facebook, Telegram, WhatsApp, TAS-IX uchun",  "*120#"),
                                    TarifModel("Cosmo 23",  "23 000 so'm",  "30 kun",  "Cosmosdagidek tasurotlarga ega bo'ling\n" +
                                            "\n" +
                                            "\n" +
                                            "BEPUL OYLIK PAKETLAR\n" +
                                            "● 720 daqiqa O‘zbekiston bo‘yicha chiquvchi qo‘ng‘iroqlar\n" +
                                            "● 150 SMS O‘zbekiston bo‘yicha chiquvchi qo‘ng‘iroqlar\n" +
                                    ...
                                    TarifModel("Cosmo 28",  "28 000 so'm",  "30 kun",  "Cosmosdagidek tasurotlarga ega bo'ling\n" +
                                            ...
                                            "\n" +
                                            "BEPUL OYLIK PAKETLAR\n" +
                                            "● 900 daqiqa O‘zbekiston bo‘yicha chiquvchi qo‘ng‘iroqlar\n" +
                                            "● 300 SMS O‘zbekiston bo‘yicha\n" +
                                            "● 3 000 MB internet trafik\n" +
                                            "● 2 000 MB ijtimoiy tarmoqlar uchun internet trafik",  "*120#"),
                                ...
                                CategoryModel("KUNLIK", listOf(
                                    ...
                                    TarifModel("Diyorim", "170 so'm","1 kun", "Diyorimning har bir go‘shasi qadrli, Farg‘ona aholisi uchun noyob taklif!\n" +
                                            "\n" +
                                            "\n" +
                                            "TARIF NARXLARI\n" +
                                            "● 170 so‘m kunlik abonent to‘lovi\n" +
                                            "● 25 so‘m tarmoq ichida chiquvchi qo‘ng‘iroqlar\n" +
                                            "● 95 so‘m O‘zbekiston bo‘yicha chiquvchi qo‘ng‘iroqlar\n" +
                                            "● 80 so‘m chiquvchi SMS-xabarlar barcha mobil operatorlarga\n" +
                                            "● 505.2 so‘m chiquvchi xalqaro SMS-xabarlarga\n" +
                                            "● 350 so‘m 1 MB Internet-trafik uchun\n" +
                                            "SHARTLAR\n" +
                                            "●  Tarifiga o‘tish narxi – 2,105 so‘m\n" +
                                            "●  Chegirmalar Farg‘ona shahri va Farg‘ona viloyati hududida amal qiladi\n" +
                                            "●  Viloyat sarhadidan chiqish holatida chegirma bekor qilinib, baholanish doimiy tartibda amalga oshiriladi",  "*717#")
                                )),
                                CategoryModel("SPECIAL", listOf(
                                    TarifModel("Special 35",  "35 000 so'm",  "30 kun",  "Hamma uchun Special! 2,000 daqiqa va 5 GB internet trafik sizga yetarlimi?\n" +
                                     ...
                                     TarifModel("Special 45",  "45 000 so'm",  "30 kun",  "Hamma uchun Special! 2,500 daqiqa va 8 GB internet trafik sizga yetarlimi?\n" +
                                        ...
                                        "\n" +
                                        "BEPUL OYLIK PAKETLAR\n" +
                                        "● 2,500 daqiqa O‘zbekiston bo‘yicha chiquvchi qo‘ng‘iroqlar\n" +
                                        "● 1000 SMS xabarlar\n" +
                                        "● 8,000 MB internet trafik\n" +
                                        "BEPUL PAKETLAR LIMITIDAN OSHGANDA\n" +
                                        "● 95 so‘m tarmoq ichida chiquvchi qo‘ng‘iroqlar\n" +
                                        "● 125 so‘m O‘zbekiston bo‘yicha chiquvchi qo‘ng‘iroqlar\n" +
                                        "● 80 so‘m chiquvchi SMS-xabarlar barcha mobil operatorlarga\n" +
                                    ...
                                    TarifModel("Special 55",  "55 000 so'm",  "30 kun",  "9 GB internet trafik va 3,000 daqiqa O‘zbekiston bo‘yicha chiqish qo‘ng‘iroqlariga nima deysiz?\n" +
                                        ...
                                        "\n" +
                                        "BEPUL OYLIK PAKETLAR\n" +
                                        "● 3,000 daqiqa O‘zbekiston bo‘yicha chiquvchi qo‘ng‘iroqlar\n" +
                                        "● 1,000 SMS xabarlar\n" +
                                        "● 11,000 MB internet trafik\n" +
                                        "BEPUL PAKETLAR LIMITIDAN OSHGANDA\n" +
                                        "● 95 so‘m tarmoq ichida chiquvchi qo‘ng‘iroqlar\n" +
                                        "● 125 so‘m O‘zbekiston bo‘yicha chiquvchi qo‘ng‘iroqlar\n" +
                                        "● 80 so‘m chiquvchi SMS-xabarlar barcha mobil operatorlarga\n" +
                                    ...
                                    TarifModel("Special 70",  "80 000 so'm",  "30 kun",  "3,500 daqiqalik chiqish qo‘ng‘iroqlari hamda 16 GB internet trafikni kutib oling!\n" +
                                        ...
                                        "\n" +
                                        "BEPUL OYLIK PAKETLAR\n" +
                                        "● 3,5000 daqiqa O‘zbekiston bo‘yicha chiquvchi qo‘ng‘iroqlar\n" +
                                        "● 1,000 SMS xabarlar\n" +
                                     ...
                                     TarifModel("Special 80",  "80 000 so'm",  "30 kun",  "7,000 daqiqalik chiqish qo‘ng‘iroqlari hamda 18 GB internet trafikni kutib oling!\n" +
                                        ...
                                        "\n" +
                                        "BEPUL OYLIK PAKETLAR\n" +
                                        "● 7,000 daqiqa O‘zbekiston bo‘yicha chiquvchi qo‘ng‘iroqlar\n" +
                                        "● 1,000 SMS xabarlar\n" +
                                    ...
                                    TarifModel("Special 125",  "125 000 so'm",  "30 kun",  "O‘zbekiston bo‘yicha CHEKSIZ chiqish qo‘ng‘iroqlariga ega bo‘ling!\n" +
                                        ...
                                        "●  02.10.2019-y. dan Special 35, Special 55, Special 80 va Special 125 tarif rejalari abonentlari faqat mazkur tariflar tizimiga hamda Active tarif rejalariga o‘tishlari mumkin bo‘ladi, boshqa tarif rejalarga o‘tish imkoniyati bo‘lmaydi",  "*120#"),
                                    TarifModel("Special Umlim Turbo",  "150 000 so'm",  "30 kun",  "Cheksiz Inernet va O‘zbekiston bo‘yicha CHEKSIZ chiqish qo‘ng‘iroqlariga ega bo‘ling!\n" +
                                            "\n" +
                                            "\n" +
                                            "BEPUL OYLIK PAKETLAR\n" +
                                            "● Cheksiz muloqot O‘zbekiston bo‘yicha chiquvchi qo‘ng‘iroqlar\n" +
                                            ...
                                            "SHARTLAR\n" +
                                            "●  Chiquvchi qo‘ng‘iroqlarning bir oylik texnologik limiti - 45,000 daqiqa\n" +
                                            "●  To'liq tezlikda 10GB, to'liq tezlikda taqdim etilgan limit tugaganidan so'ng, internet tezligi 128kbit/soniyagacha qilib belgilanadi.\n" +
                                            "●  Tarif rejasida Restart xizmatidan foydalanish mumkin\n" +
                                            "●  «2 GB» aksiyasi doirasida 10,000 so‘mga 2 GB hajmidagi internet-to‘plamni 30.07.2019 dan to 26.12.2019 gacha sotib olish mumkin, internet-to‘plamini faollashtirish - *255#\n" +
                                            "●  Tarif rejasiga o‘tish narxi - 0 so‘m\n" +
                                            "●  02.10.2019-y. dan Special 35, Special 55, Special 80 va Special 125 tarif rejalari abonentlari faqat mazkur tariflar tizimiga hamda Active tarif rejalariga o‘tishlari mumkin bo‘ladi, boshqa tarif rejalarga o‘tish imkoniyati bo‘lmaydi",  "*120#"),
                                    ...
                                    TarifModel("Special Unlim",  "139 000 so'm",  "30 kun",  "Cheksiz Inernet va O‘zbekiston bo‘yicha CHEKSIZ chiqish qo‘ng‘iroqlariga ega bo‘ling!\n" +
                                        ...
                                        "\n" +
                                        "BEPUL OYLIK PAKETLAR\n" +
                                        "● VIP daqiqa O‘zbekiston bo‘yicha chiquvchi qo‘ng‘iroqlar\n" +
                                        "● 3,000 SMS xabarlar\n" +
                                        "● VIP MB internet trafik\n" +
                                        "BEPUL PAKETLAR LIMITIDAN OSHGANDA\n" +
                                        "● 95 so‘m tarmoq ichida chiquvchi qo‘ng‘iroqlar\n" +
                                        "● 125 so‘m O‘zbekiston bo‘yicha chiquvchi qo‘ng‘iroqlar\n" +
                                        "● 80 so‘m chiquvchi SMS-xabarlar barcha mobil operatorlarga\n" +
                ...
                OPERATOR_UMS -> {
                    when(category){
                        CATEGORY_INTERNET -> {
                            return listOf(
                                CategoryModel("KUNLIK", listOf(
                                    InternetModel("Internet 50", "2500 so'm", "50 MB", "", "*102*50#"),
                                    InternetModel("Internet 100", "4000 so'm", "100 MB", "", "*102*100#"),
                                    InternetModel("Internet 200", "6000 so'm", "200 MB", "", "*102*1*200#"),
                                    InternetModel("Internet 300", "7000 so'm", "300 MB", "", "*102*1*300#"),
                                    InternetModel("Internet 500", "7500 so'm", "500 MB", "", "*102*1*500#"),
                                    InternetModel("Internet 1000", "10000 so'm", "1000 MB", "", "*102*1*1000#"),
                                    InternetModel("Internet 2000", "14000 so'm", "2000 MB", "", "*102*1*2000#"),
                                    InternetModel("Internet 3000", "19000 so'm", "3000 MB", "", "*102*1*3000#"),
                                    InternetModel("Internet 5000", "24000 so'm", "5000 MB", "", "*102*1*5000#"),
                                    InternetModel("Internet 10000", "35000 so'm", "10000 MB", "", "*102*1*10000#")
                                )),
                                CategoryModel("OYLIK",  listOf(
                                    InternetModel("300 MB", "8 000 so'm", "300 MB", "", "*171*019*1*011500201#"),
                                    InternetModel("500 MB", "9 000 so'm", "500 MB", "", "*171*019*7*011500201#"),
                                    InternetModel("1000 MB", "11 000 so'm", "1000 MB", "", "*171*019*2*011500201#"),
                                    InternetModel("2000 MB", "17 000 so'm", "2000 MB", "", "*171*019*5*011500201#"),
                                    InternetModel("3000 MB", "25 000 so'm", "3000 MB", "", "*171*019*3*011500201#"),
                                    InternetModel("5000 MB", "33 000 so'm", "5000 MB", "", "*171*019*4*011500201#"),
                                    InternetModel("10000 MB", "50 000 so'm", "10000 MB", "", "*171*019*6*011500201#"),
                                    InternetModel("20000 MB", "55 000 so'm", "20000 MB", "", "*171*019*8*011500201#"),
                                    InternetModel("30000 MB", "65 000 so'm", "30000 MB", "", "*171*019*9*011500201#"),
                                    InternetModel("50000 MB", "75 000 so'm", "50000 MB", "", "*171*019*10*011500201#")
                                )),
                                CategoryModel("TUNGI", listOf(
                                    InternetModel("Tungi to’plam 1 000", "5 000 so'm", "1000 MB", "", "*171*203*1000*011500201#"),
                                    InternetModel("Tungi to’plam 2 000", "9 500 so'm", "2000 MB", "", "*171*203*2000*011500201#"),
                                    InternetModel("Tungi to’plam 3 000", "12 500 so'm", "3000 MB", "", "*171*203*3000*011500201#"),
                                    InternetModel("Tungi to’plam 5 000", "17 000 so'm", "5000 MB", "", "*171*203*5000*011500201#"),
                                    InternetModel("Tungi to’plam 10 000", "22 000 so'm", "10000 MB", "", "*171*203*10000*011500201#"),
                                    InternetModel("Tungi to’plam 20 000", "33 000 so'm", "20000 MB", "", "**171*203*20000*011500201#"),
                                    InternetModel("Tungi to’plam 50 000", "44 000 so'm", "50000 MB", "", "*171*203*50000*011500201#")
                                )), CategoryModel("Tungi DRIVE", listOf(
                                    InternetModel("Tungi Drive", "00:00-08:00", "Cheksiz", "", ""),
                                    InternetModel("Tungi DRIVE 1", "10 000 so'm", "Cheksiz", "Amal qilish muddati 1 kun", "*171*200*1*011500201#"),
                                    InternetModel("Tungi DRIVE 7", "45 000 so'm", "Cheksiz", "Amal qilish muddati 7 kun", "*171*200*7*011500201#"),
                                    InternetModel("Tungi DRIVE 30", "120 000 so'm", "Cheksiz", "Amal qilish muddati 30 kun", "*171*200*30*011500201#")
                                )),
                                CategoryModel("ONNET", listOf(
                                    InternetModel("OnNet 300 MB", "8 000 so'm(Birinchi oy uchun)", "300 MB", "Keyingi oylaradagi narhi(-10%)-7 200 so'm", "*171*202*300*011500201#"),
                                    InternetModel("OnNet 500 MB", "9 000 so'm(Birinchi oy uchun)", "500 MB", "Keyingi oylaradagi narhi(-10%)-8 100 so'm", "*171*202*500*011500201#"),
                                    InternetModel("OnNet 1000 MB", "11 000 so'm(Birinchi oy uchun)", "1000 MB", "Keyingi oylaradagi narhi(-10%)-9 900 so'm", "*171*202*1000*011500201#"),
                                    InternetModel("OnNet 2000 MB", "17 000 so'm(Birinchi oy uchun)", "2000 MB", "Keyingi oylaradagi narhi(-10%)-15 300 so'm", "*171*202*2000*011500201#"),
                                    InternetModel("OnNet 3000 MB", "25 000 so'm(Birinchi oy uchun)", "3000 MB", "Keyingi oylaradagi narhi(-10%)-22 500 so'm", "*171*202*3000*011500201#"),
                                    InternetModel("OnNet 5000 MB", "33 000 so'm(Birinchi oy uchun)", "5000 MB", "Keyingi oylaradagi narhi(-10%)-29 700 so'm", "*171*202*5000*011500201#"),
                                    InternetModel("OnNet 10000 MB", "50 000 so'm(Birinchi oy uchun)", "10000 MB", "Keyingi oylaradagi narhi(-10%)-45 000 so'm", "*171*202*10000*011500201#"),
                                    InternetModel("OnNet 20000 MB", "55 000 so'm(Birinchi oy uchun)", "20000 MB", "Keyingi oylaradagi narhi(-10%)-49 500so'm", "*171*202*20000*011500201#"),
                                    InternetModel("OnNet 30000 MB", "65 000 so'm(Birinchi oy uchun)", "30000 MB", "Keyingi oylaradagi narhi(-10%)-58 500 so'm", "*171*202*30000*011500201#"),
                                    InternetModel("OnNet 50000 MB", "75 000 so'm(Birinchi oy uchun)", "50000 MB", "Keyingi oylaradagi narhi(-10%)-67 500 so'm", "*171*202*50000*011500201#")
                                ))
                            )
                        }
                        CATEGORY_TARIF -> {
                            return listOf(
                                CategoryModel("FAOL MULOQOT UCHUN", listOf(
                                    ...
                                    TarifModel("Omad Plus", "12 000 so'm","30 kun", "Omadli insonlarning tanlovi ham omadlidir! O‘zingiz uchun yangi omadni kashf eting!\n" +
                                            ...
                                            "●  Ajoyib, Chilla, Chilla Lite, Mini, Terminal, UMS bilan birga, Veteran, Asosiy, Standart, Optimal+, Qulay+, Connect, Yorqin, Premial, Ideal, VIP, Absolut, Absolut Year, Exclusive, Qulay Yillik+, Yorqin Yillik, Premial Yillik, Ideal Yillik, VIP Yillik tariflaridan o‘tish - 4210.35 so‘m",  "*171*043*011500201#"),
                                    TarifModel("Chilla Lite", "20 000 so'm","30 kun", "Chillada yana nima qilish mumkin? Dam olishdan zerikdingizmi? Muloqotni boshlang!\n" +
                                            ...
                                            "●  Ushbu tarifida Super 0 xizmatidan foydalanib bo‘lmaydi",  "*171*042*011500201#"),
                                    TarifModel("GAP yo'q", "35 000 so'm","30 kun", "Tarifga GAP yo'q" +
                                            ...
                                            "● 12 so‘m chiquvchi xalqaro SMS-xabarlarga\n" +
                                            "● 12 so‘m 1 MB Internet-trafik uchun\n" +"",
                                         "*171*100*011500201#"),
                                    ...
                                    TarifModel("Yorqin", "60 000 so'm","30 kun", "Qulay internet orqali dunyoga nigoh tashlang, yorqin taassurotlarni kashf eting!\n" +
                                            "\n" +
                                            "\n" +
                                            "OYLIK BEPUL PAKETLAR\n" +
                                            ...
                                            "SHARTLAR\n" +
                                            "●  Internet-trafikni narxlash kvanti - 1 KB\n" +
                                            "●  Premial, Ideal, VIP, Maxi, Maxi New, Ultra, Perfect, Maxi Year, 777 Year, Ultra Year, Absolut, Absolut Year, Premial Yillik, Ideal Yillik, VIP Yillik, Qulay Yillik, Qulay Yillik+ tariflaridan o‘tib bo‘lmaydi\n" +
                                            "●  Tarifga ulanish davri 2019 yil 3 maydan 2019 yil 31 avgust kuni oxirigacha\n" +
                                            "●  Ushbu tarifida Super 0 xizmati ishlaydi\n" +
                                            "\n" +
                                            "Internet paketlar va tariflarga oson ulaning - barcha USSD kodlar bir joyda!",  "*171*113*011500201*1#")
                                ...
                                CategoryModel("CHEKSIZ MULOQOT", listOf(
                                    TarifModel("Mobi 20", "20 000 so'm","30 kun", "O‘zbekiston bo‘ylab 500 daqiqa chiqish qo‘ng‘iroqlari va " +
                                            ...
                                            "SHARTLAR\n" +
                                            "●  Internet-trafikni narxlash kvanti - 1 KB\n" +
                                            "●  Faxriy, UMS bilan birga tarif rejalaridan o‘tish narxi - 0 so‘m;\n" +
                                            "●  Absolut, Plus, My UMS, Mini, Absolut Year, Besh, 777, Perfect, Terminal, Gap bor!, Connect, Ajoyib, Optimal+, Qulay+, Premial, Ideal, VIP, Asosiy, Standart, Premial Yillik, Ideal Yillik, VIP Yillik, Qulay Yillik+, Chilla, Ekskluziv, Chilla Lite, Yorqin, Oson, Yorqin Yillik, Shodlik, Terminal Yillik, O‘qituvchi 1, O‘qituvchi 2, Omad tarif rejalaridan o‘tish narxi - 4210,35 so‘m\n" +
                                            "●  Ushbu tarifida “Super 0” xizmati ishlaydi\n" +
                                            "●  Abonent to‘lovi har oyning 1-sanasida yechib olinadi\n" +
                                            "●  Tarif rejasini 1 kunda faqat 1 marta o‘zgartirish mumki",  "*171*120*011500201#"),
                                    TarifModel("Mobi 30", "30 000 so'm","30 kun", "O‘zbekiston bo‘ylab 1000 daqiqa chiqish qo‘ng‘iroqlari va " +
                                            ...
                                            "●  Ushbu tarifida “Super 0” xizmati ishlaydi\n" +
                                            "●  Abonent to‘lovi har oyning 1-sanasida yechib olinadi\n" +
                                            "●  Tarif rejasini 1 kunda faqat 1 marta o‘zgartirish mumki",  "*171*128*011500201#"),
                                    ...
                                    TarifModel("Mobi 50", "50 000 so'm","30 kun", "Tarmoq ichida cheksiz qo‘ng‘iroqlardan baxra oling, O‘zbekiston bo‘yicha esa 1500 daqiqa!\n" +
                                            ...
                                            "SHARTLAR\n" +
                                            "●  Internet-trafikni narxlash kvanti - 1 KB\n" +
                                            "●  Absolut, Plus, My UMS, Mini, Absolut Year, Besh, Terminal, Optimal+, Qulay+, Premial, Ideal, VIP, Asosiy, Standart, Premial Yillik, Ideal Yillik, VIP Yillik, Qulay Yillik+, Chilla, Chilla Lite, Yorqin, Oson, Yorqin Yillik, Shodlik, Terminal Yillik, O‘qituvchi 1, O‘qituvchi 2, Omad tariflaridan o‘tish - 4210,35 so‘m\n" +
                                            "●  Ushbu tarifida “Super 0”, konferents-aloqa xizmatlari ishlamaydi\n" +
                                            "●  Abonent to‘lovi har oyning 1-sanasida yechib olinadi\n" +
                                            "●  Tarif rejasini 1 kunda faqat 1 marta o‘zgartirish mumkin\n" +
                                            "\n" +
                                            "Internet paketlar va tariflarga oson ulaning - barcha USSD kodlar bir joyda!",  "*171*129*011500201*1#"),
                                    TarifModel("Mobi 70", "70 000 so'm","30 kun", "Cheksiz qo‘ng‘iroqlar tarmoq ichida hamda 2,500 daqiqa O‘zbekiston bo‘yicha chiqish qo‘ng‘iroqlari\n" +
                                            ...
                                            "SHARTLAR\n" +
                                            "●  Internet-trafikni narxlash kvanti - 1 KB\n" +
                                            "●  \"Mobi 90\" tarif rejasiga/dan boshqa tariflardan/ga o‘tish narxi - 4210,35 so‘m\n" +
                                            "●  Faxriy, UMS bilan birga tariflardan o‘tish - 0 so‘m\n" +
                                            "●  Ushbu tarifida “Super 0”, konferents-aloqa xizmatlari ishlamaydi\n" +
                                            "●  Abonent to‘lovi har oyning 1-sanasida yechib olinadi\n" +
                                            "●  Tarif rejasini 1 kunda faqat 1 marta o‘zgartirish mumkin",  "*171*131*011500201*1#"),
                                    TarifModel("Mobi 90", "90 000 so'm","30 kun", "O‘zbekiston bo‘yicha 3,500 daqiqa va tarmoq ichida cheksiz chiqish qo‘ng‘iroqlari\n" +
                                            ...
                                            "●  Ushbu tarifida “Super 0”, konferents-aloqa xizmatlari ishlamaydi\n" +
                                            "●  Abonent to‘lovi har oyning 1-sanasida yechib olinadi\n" +
                                            "●  Tarif rejasini 1 kunda faqat 1 marta o‘zgartirish mumkin",  "*171*132*011500201*1#"),
                                    TarifModel("Mobi 110", "110 000 so'm","30 kun", "25,000 MB mobil internet trafigi mayliku O‘zbekiston bo‘yicha VIP qo‘ng‘iroqlarga nima deysiz?\n" +
                                            ...
                                            "SHARTLAR\n" +
                                            "●  Internet-trafikni narxlash kvanti – 1 KB\n" +
                                            "●  Faxriy, UMS bilan birga tariflaridan o‘tish narxi – 0 so‘m\n" +
                                            "●  Qolgan barcha tariflardan o‘tish narxi – 4210,35 so‘m\n" +
                                            "●  Ushbu tarifida “Super 0”, konferents-aloqa xizmatlari ishlamaydi\n" +
                                            "●  Abonent to‘lovi har oyning 1-sanasida yechib olinadi\n" +
                                            "●  Tarif rejasini 1 kunda faqat 1 marta o‘zgartirish mumkin",  "*171*133*011500201*1#"),
                                    TarifModel("Mobi 150", "150 000 so'm","30 kun", "50 GB mobil internet trafigiga ega cheksiz qo‘ng‘iroqlar tarifiga ulaning, internetda ham erkin muloqot qiling!\n" +
                                            ...
                                            "●  Ushbu tarifida “Super 0”, konferents-aloqa xizmatlari ishlamaydi\n" +
                                            "●  Abonent to‘lovi har oyning 1-sanasida yechib olinadi\n" +
                                            "●  Tarif rejasini 1 kunda faqat 1 marta o‘zgartirish mumkin",  "*171*134*011500201*1#")
                                ...
                                CategoryModel("IMTIYOZLI", listOf(
                                    ...
                                    TarifModel("UMS bilan birga", "8 420 so'm","30 kun", "Mehrga muhtoj insonlanlar doimo etiborimizda, ular uchun imtiyozli tarif rejasi!\n" +
                                            "\n" +
                                            "\n" +
                                            "OYLIK BEPUL PAKETLAR\n" +
                        ...
                        CATEGORY_MINUTES -> {
                            return listOf(
                                CategoryModel("", listOf(
                                    MinuteModel("60 daqiqalik to‘plam", "4 000 so'm", "60 daqiqa", "616020 raqamiga 60", "*171*103*60*1*01010240#"),
                                    MinuteModel("120 daqiqalik to‘plam", "7 000 so'm", "120 daqiqa", "616020 raqamiga 120", "*171*103*120*1*01010240#"),
                                    MinuteModel("180 daqiqalik to‘plam", "10 000 so'm", "120 daqiqa", "616020 raqamiga 180", "*171*103*180*1*01010240#"),
                                    MinuteModel("300 daqiqalik to‘plam", "16 000 so'm", "300 daqiqa", "616020 raqamiga 300", "*171*103*300*1*01010240#"),
                                    MinuteModel("900 daqiqalik to‘plam", "37 000 so'm", "900 daqiqa", "616020 raqamiga 900", "*171*103*900*1*01010240#"),
                                    MinuteModel("1200 daqiqalik to‘plam", "45 000 so'm", "1200 daqiqa", "616020 raqamiga 1200", "*171*103*1200*1*01010240#"),
                                    MinuteModel("1800 daqiqalik to‘plam", "62 000 so'm", "1800 daqiqa", "616020 raqamiga 1800", "*171*103*1800*1*01010240#")
                                ))
                            )
                        }
                        CATEGORY_SMS -> {
